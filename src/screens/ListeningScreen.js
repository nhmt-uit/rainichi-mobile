...
import ListeningQuestion from '../components/question/ListeningQuestion';
import {openNextCourse} from '../redux/actions';
import {i18n} from '../../locales';

// Ported from the old app's ListeningScreen.js.
export default function ListeningScreen({navigation, route}) {
  ...
  return (
    <Background style={styles.container}>
      <ListeningQuestion question={item} enableCheckAnser />
    </Background>
  );
}
